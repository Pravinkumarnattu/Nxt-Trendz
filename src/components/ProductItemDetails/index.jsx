...
class ProductItemDetailsWithParams extends Component {
  state = {
    productData: {},
    similarProductsData: [],
  ...
  componentDidMount() {
    ...
    this.setState({ productId }, this.getProductData);
  }

  componentDidUpdate(prevProps) {
    const { productId } = this.props;
    if (prevProps.productId !== productId && this.props.productId) {
      this.setState({ productId }, this.getProductData);
    }
  }
...
const ProductItemDetails = () => (
  <ParamsWrapper
    render={(id) => <ProductItemDetailsWithParams productId={id} />}
  />
);
